  ...
  return (
    ...
    >
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <div className="absolute z-[0] xl:w-[80%] xl:h-[55%]  w-[40%] h-[35%] top-0 pink__gradient" />
        <div className="absolute z-[1] xl:w-[100%] w-[80%] h-[80%] rounded-full white__gradient bottom-40" />
        <div className="absolute z-[0] xl:w-[70%] xl:h-[70%] w-[50%] h-[50%] right-20 bottom-20 blue__gradient" />
      </div>
